    ...
    public class Emp_BasicInfoBal
    {
        public Emp_BasicInfoModels GetEmpManager(ClientContext clientContext,string Empcode)
        {
            ...
            EmpBal = new Emp_BasicInfoModels
            {
                ...
                Manager_Code = jArray[0]["Manager"]["Manager_Code"] == null ? "" : Convert.ToString(jArray[0]["Manager"]["Manager_Code"]),
        ...
        private JArray RestGetEmp(ClientContext clientContext,string filter)
        {
            ...
            selectqry += "Company/CompanyName,Manager_Code,User_Name/Id,User_Name/Title,Manager/FirstName,Manager/EmpCode,Manager/Manager_Code,Manager/Id";
